<a 
  ...
  <figure>
    ...
    <figcaption class="text-lumora lg:p-20 hyphens-auto text-xl md:text-2xl text-center absolute inset-0 flex items-center justify-center text-balance md:opacity-0 group-hover:opacity-100 transition-opacity duration-200">
      {{ $building->title }}
    </figcaption>
  </figure>
</a>