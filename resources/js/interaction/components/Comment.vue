<template>
  <div class="relative">
    <a
      ...
      class="group"
      v-if="!props.isOpen">
      <CommentIcon class="text-white group-hover:text-lumora transition-all" />
    </a>
  
    <div 
      class="absolute top-35 md:top-34 xl:top-43 -translate-y-full left-0 w-210 md:w-[240px] xl:w-[360px] h-auto" 
      v-if="props.isOpen">
      <div class="relative w-full border-3 xl:border-4 border-black bg-white p-10">
        <a 
          href="javascript:;" 
          @click.prevent="toggleForm"
          ...
          <div class=" top-0 left-0 w-full h-full flex flex-col justify-between">
            <form @submit.prevent="submitComment">
              ...
              <textarea
                ...
                :class="{ 'placeholder:!text-red-500': hasError }"
                rows="5">
              </textarea>
